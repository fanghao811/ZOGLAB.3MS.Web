...
using ZOGLAB.S_3MS.Web.App.Startup;//SPA!
using ZOGLAB.S_3MS.Web.Areas.Mpa.Startup;//MPA!
using ZOGLAB.S_3MS.Web.Bundling;
using ZOGLAB.S_3MS.Web.Navigation;
using ZOGLAB.S_3MS.Web.Routing;
using ZOGLAB.S_3MS.WebApi;

namespace ZOGLAB.S_3MS.Web
{
    /// <summary>
